...
const getHigherGrade = (higherGrade, subjectGrade) => ((higherGrade.nota > subjectGrade.nota) ? higherGrade : subjectGrade);

const reportBetterSubject = (estudantes) => estudantes.map((student) => (
    {
        name: student.nome,
        subject: student.materias.reduce(getHigherGrade).name,
    }
));
console.log(reportBetterSubject(estudantes));